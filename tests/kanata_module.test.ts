...
describe('Kanata module', () => {
  ...
  it('provides filtered macOS Kanata profiles', () => {
    ...
    // Microsoft Sculpt Application/Menu reports macOS keyCode 110, which Kanata maps to `menu`.
    expect(content).toContain('menu caps');
    expect(sculpt).toContain('menu caps');
    expect(content).toContain(defsrc);
