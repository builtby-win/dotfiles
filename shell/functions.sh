...
bb() {
  ...
  case "$cmd" in
    help|-h|--help)
      ...
      echo "  bb setup                Open guided setup checklist (add/remove tools)"
      echo "  bb setup revert         Restore files from backups"
      echo "  bb setup <module>       Install a single module (shell, tmux, nvim, etc.)"
      echo "  bb setup menu           Advanced setup options"
      echo ""
